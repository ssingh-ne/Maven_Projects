...
public class AUW_callupdate {
	
WebDriver driver;
	
	public AUW_callupdate (WebDriver driver){
		this.driver =driver;
	}
 ...
 public void  Facts_View () throws InterruptedException {
	 ...
	 js.executeScript("arguments[0].scrollIntoView();", Element);
	   ...
	   WebDriverWait wait = new WebDriverWait(driver,30);
		...
		System.out.println("Fatc URL = "+Exp_url);
 ...
 public void  Facts_Download () throws InterruptedException {
     ...
     WebDriverWait wait = new WebDriverWait(driver,30);
		...
		System.out.println("Download href link = "+Exp_url);
