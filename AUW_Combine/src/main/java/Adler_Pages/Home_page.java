...
//	By News_Image = By.xpath("(//*[contains(@class,'fadeAltClass-1')])[1]/div/a/div/img");
	By News_Image = By.xpath("//*[@alt='Adler - Shorts tool to Pinnacle Molds']");
...
//By News_Image2 = By.xpath("(//*[contains(@class,'fadeAltClass-2')])[1]/div/a/div/img");
	By News_Image2 = By.xpath("//*[@alt='Adler Acquisition of Rapid Mold Solutions']");
	...
	By Load_More_prod = By.xpath("//*[text()='More News']");
...
// By News_Image3 = By.xpath("(//*[contains(@class,'fadeAltClass-1')])[2]/div/a/div/img");
	By News_Image3= By.xpath("//*[@alt='Adler Yasda Machining Center QA testing the long message']");
...
//	By News_Image4 = By.xpath("(//*[contains(@class,'fadeAltClass-2')])[2]/div/a/div/img");
	By News_Image4 = By.xpath("//*[@alt='Adler - Profit Sharing - Shorts Tool']");
	...
	By AboutUs_prod = By.xpath("//*[text()='About Adler']");
	
	
	By privacy_policy = By.xpath("//*[text()='Privacy Policy']");
	By privacy_url = By.xpath("(//*[@target='_self'])[4]");
	

	By privacy_url_prod = By.xpath("(//*[@target='_self'])[3]");
   ...
   public void PrivacyPolicy_prod () throws InterruptedException {
		 ...
		 String URL = driver.findElement(privacy_url_prod).getAttribute("href");
		 System.out.println("URL before click = " + URL);
   ...
   public void News3_prod () throws InterruptedException {
	   
	   JavascriptExecutor js = (JavascriptExecutor) driver;
	   WebElement Element = driver.findElement(Load_More_prod);
	   js.executeScript("arguments[0].scrollIntoView();", Element);
		  
	   Thread.sleep(3000);
	   
	   driver.findElement(Load_More_prod).click();
   ...
   public void About_Us_prod () throws InterruptedException {
	   ...
	   JavascriptExecutor js = (JavascriptExecutor) driver;
	   WebElement Element = driver.findElement(AboutUs_prod);
	   js.executeScript("arguments[0].scrollIntoView();", Element);
	   
	   Thread.sleep(5000);
	   
	  boolean contact =  driver.findElement(AboutUs_prod).isDisplayed();
